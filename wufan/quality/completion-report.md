...
- 档案：`wufan` v0.3.0
- 检查时间：2026-07-28T23:00:47Z
- 当前状态：`analyzed`
- 来源：55
- TODO：7/15 完成；8 open；6 blocker
- REQUESTS：8 open
- 自检结论：**登录小人组件范围通过；complete 门槛未通过。**
...
`exact-source, pass-within-component-scope`；下一轮仍优先获得安全登录态探索方式、
当前部署源码映射和其余 private/public 发布范围确认。
